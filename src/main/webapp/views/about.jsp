...
<div class="row">
    <div class="jumbotron">
        <p>
            This is a project made from TEES - Tópicos Especiais em Engenharia de Software (Software Engineering Special Topics) - discipline at UNEB - Universidade do Estado da Bahia (Bahia State University), over the topic of Software Product lines.
        </p>
        <p>
