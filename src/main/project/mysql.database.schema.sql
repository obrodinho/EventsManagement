...
-- -----------------------------------------------------
-- Base de dados Da Família de Produtos de Gestão de Eventos e Cursos
...
ENGINE = InnoDB
COMMENT = 'Table to hold all system options' /* comment truncated */ /*
...
CREATE TABLE IF NOT EXISTS `events_management`.`activities` (
  ...
  `updated` DATETIME NULL,
  PRIMARY KEY (`acitivity_id`, `event_id`),
...
CREATE TABLE IF NOT EXISTS `events_management`.`classes` (
  ...
  CONSTRAINT `fk_classes_activity`
    ...
    REFERENCES `events_management`.`activities` (`acitivity_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `events_management`.`class_profiles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `events_management`.`class_profiles` ;

CREATE TABLE IF NOT EXISTS `events_management`.`class_profiles` (
...
-- -----------------------------------------------------
-- Table `events_management`.`class_subscription`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `events_management`.`class_subscription` ;

CREATE TABLE IF NOT EXISTS `events_management`.`class_subscription` (
  ...
  CONSTRAINT `fk_class_subscription_profile_id`
    FOREIGN KEY (`profile_id`)
    REFERENCES `events_management`.`class_profiles` (`profile_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
